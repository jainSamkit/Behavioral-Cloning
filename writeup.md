...
**The repo includes all required files and can be used to run the simulator in autonomous mode**
...
**The repo includes the functional code**
Using the Udacity provided simulator and my drive.py file, the car can be driven autonomously around the track by executing 
```sh
python drive.py model.h5
```

**The submission code is usable and readable**
